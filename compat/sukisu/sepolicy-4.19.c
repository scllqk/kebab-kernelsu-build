/*
 * Linux 4.19 SELinux policydb compatibility layer for SukiSU-Ultra.
 * Based on the GPL-2.0 legacy policydb implementation from KernelSU-Next v1.1.1.
 * SukiSU-Ultra remains the root engine; this file only adapts the pre-5.1 SELinux ABI.
 */
#include <linux/gfp.h>
